...
/****************************************************
 * Environment Setup for Maximum Character Input
 * If Character More Than 250 The Submit Automatic
 * disabled and Trigger a message for few seconds.
 */
const maxLength = 250;
...
/*********************************************************
 * Data Store, Save and Delete In LocalStorage
 */
 ...
 * By finding ID we update tweets
 * Then update in data Store, UI and LocalStorage
 */
...
function initialAddState(){
    ...
    //display add button
    addTweetBtn.style.display = 'inline-block';
   // reset value
    inputTweet.value = '';
}

/***************************************************
 * Update and Remove Tweets
 */
...
/**********************************************
 * Filtering Tweets
 * If Not Matched With Criterial
 * The 'FilterMessage' will Trigger
 */
